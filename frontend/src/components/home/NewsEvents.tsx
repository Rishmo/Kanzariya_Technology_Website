...
const newsItems = [
  {
    id: 1,
    title: "Kanzariya Technology Unveils New ThreatCloud AI 3.0 Technology",
    date: "May 15, 2025",
  ...
  {
    id: 3,
    title: "Kanzariya Technology Recognized as Leader in Gartner Magic Quadrant",
    date: "April 10, 2025",
    category: "Award",
    excerpt: "For the 15th consecutive year, Kanzariya Technology has been positioned as a Leader in the Gartner Magic Quadrant for Network Firewalls.",
  ...
  },
  {
    ...
    excerpt: "Kanzariya Technology announces strategic partnership with one of the world's largest financial institutions to enhance security posture.",
