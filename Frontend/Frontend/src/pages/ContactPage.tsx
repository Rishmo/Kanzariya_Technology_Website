...
const ContactPage = () => {
  ...
  useEffect(() => {
    document.title = 'Contact Us - CheckPoint';
    window.scrollTo(0, 0);
  }, []);
            ...
            <div>
              ...
              <div className="space-y-6">
                <ContactItem
                  ...
                  details={[`5 Ha'solelim Street`, 'Tel Aviv 6789705, Israel']}
                />
                <ContactItem
                  icon={<Phone className="h-6 w-6" />}
                  title="Phone"
                  details={['+1 (800) 429-4391 (US)', '+972 3 753 4555 (International)']}
                />
                <ContactItem
                  icon={<Mail className="h-6 w-6" />}
                  title="Email"
                  details={['info@checkpoint.com', 'support@checkpoint.com']}
                />
              </div>
